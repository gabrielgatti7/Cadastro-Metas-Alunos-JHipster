...
import { sampleWithRequiredData } from '../simulado.test-samples';
import { SimuladoService } from '../service/simulado.service';

import { SimuladoComponent } from './simulado.component';
import SpyInstance = jest.SpyInstance;

describe('Simulado Management Component', () => {
  let comp: SimuladoComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(SimuladoComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.simulados()[0]).toEqual(expect.objectContaining({ id: 22678 }));
  });

  describe('trackId', () => {
    it('should forward to simuladoService', () => {
      const entity = { id: 22678 };
      jest.spyOn(service, 'getSimuladoIdentifier');
      const id = comp.trackId(entity);
      expect(service.getSimuladoIdentifier).toHaveBeenCalledWith(entity);

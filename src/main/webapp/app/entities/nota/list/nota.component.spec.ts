...
import { sampleWithRequiredData } from '../nota.test-samples';
...
describe('Nota Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.notas()[0]).toEqual(expect.objectContaining({ id: 21411 }));
  });

  describe('trackId', () => {
    it('should forward to notaService', () => {
      const entity = { id: 21411 };
      jest.spyOn(service, 'getNotaIdentifier');
      const id = comp.trackId(entity);
      expect(service.getNotaIdentifier).toHaveBeenCalledWith(entity);

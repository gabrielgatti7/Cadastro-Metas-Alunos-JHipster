...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '434c8488-0380-44d1-82f5-c651f266d011' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('0139cecb-7786-4ddc-9326-10bee721c906');
      cy.get(`[data-cy="name"]`).should('have.value', '0139cecb-7786-4ddc-9326-10bee721c906');
